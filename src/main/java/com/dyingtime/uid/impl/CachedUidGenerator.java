 ...
 */
package com.dyingtime.uid.impl;

import java.util.ArrayList;
import java.util.List;

import com.dyingtime.uid.UidGenerator;
import com.dyingtime.uid.UidProperties;
import com.dyingtime.uid.buffer.BufferPaddingExecutor;
import com.dyingtime.uid.buffer.RejectedPutBufferHandler;
import com.dyingtime.uid.buffer.RejectedTakeBufferHandler;
import com.dyingtime.uid.buffer.RingBuffer;
import com.dyingtime.uid.exception.UidGenerateException;
...
import com.dyingtime.uid.BitsAllocator;
 ...
 * @author yutianbao
 */
@ConfigurationProperties(prefix = "com.dyingtime.uid.cached")
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    public void setPaddingFactor(int paddingFactor) {
        Assert.isTrue(boostPower > 0, "Padding factor must be positive!");
        Assert.isTrue(boostPower <= 100, "Padding factor must be less than 100!");
